            ...
            <div style={styles.thirdPartyDetail}>
              ...
              >
                <img
                  ...
                  alt=""
                />
                <h5 style={styles.thirdPartyName}>环网充气柜</h5>
              ...
              <div style={styles.thirdPartyDetailItem}>
                <img
                  ...
                  alt=""
                />
                <h5 style={styles.thirdPartyName}>SF6充气柜</h5>
                {/* <p style={styles.thirdPartySold}>
                  已售：
              ...
              <div style={styles.thirdPartyDetailItem}>
                <img
                  ...
                  alt=""
                />
                <h5 style={styles.thirdPartyName}>高低压成套</h5>
                {/* <p style={styles.thirdPartySold}>
                  已售：
              ...
              >
                <img
                  ...
                  alt=""
                />
                <h5 style={styles.thirdPartyName}>高压电揽分支箱</h5>
                {/* <p style={styles.thirdPartySold}>
                  已售：
